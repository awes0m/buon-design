...
class AuthController extends StateNotifier<bool> {
  ...
  Future<void> signinWithGoogle(BuildContext context) async {
    state = true;
    final Either<Failure, AppUserInfo?> res = await _authAPI.signInWithGoogle();
    state = false;
    res.fold((Failure l) => showSnackBar(context, l.message),
        (AppUserInfo? r) => navigateToHomepage(context, r));
  }

  Future<void> signinWithFacebook(BuildContext context) async {
    state = true;
    final Either<Failure, AppUserInfo?> res =
  ...
  Future<void> signinWithApple(BuildContext context) async {
    state = true;
    final Either<Failure, AppUserInfo?> res = await _authAPI.signInwithApple();
    state = false;
    res.fold((Failure l) => showSnackBar(context, l.message),
        (AppUserInfo? r) => navigateToHomepage(context, r));
  }
